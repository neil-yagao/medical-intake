<template>
	<div>
		<div class="row">
			<div class="col-md-3"> 
				<ul class="list-group">
					<li class="list-group-item" role="button" :class="this.$route.path.indexOf('medical-inventory/overall') >= 0?'list-group-item-success':''"> <a href="#/working/medical-inventory/overall" >药物存量查询</a></li>
